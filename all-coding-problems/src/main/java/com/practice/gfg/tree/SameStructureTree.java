...
public class SameStructureTree {
	...
	public static void main(String[] args) {
		...
		root2.setLeft(new Node(20));
		root2.setRight(new Node(22));
		root2.getLeft().setLeft(new Node(5));
		root2.getLeft().setRight(new Node(31));
	...
	private static boolean checkIfSameStructure(Node root1, Node root2) {
		return checkIfSameStructureUtil(root1, root2);
	}

	private static boolean checkIfSameStructureUtil(Node root1, Node root2) {
